    ...
    if msg.reply_to_message:
        ...
        if not is_animated:
            try:
                ...
                msg.reply_text(
                    f"This Sticker was Kanged Sucessfully\nThe Sticker Pack Can be Located [Valt Aoi Stickers](t.me/addstickers/{packname})"
                ...
                if e.message == "Stickerset_invalid":
                    ...
                    msg.reply_text(
                        f"Sticker successfully added to [VALT AOI STICKERS](t.me/addstickers/{packname})"
                    ...
                    msg.reply_text(
                        "Sticker successfully added to [Valt Aoi Sickers](t.me/addstickers/%s)"
                        % packname
                        + "\n"
                        "Emoji is:" + " " + sticker_emoji,
                        parse_mode=ParseMode.MARKDOWN,
            ...
            try:
                ...
                if e.message == "Stickerset_invalid":
                    ...
                    msg.reply_text(
                        "Sticker successfully added to [VALT AOI STICKERS](t.me/addstickers/%s)"
                        % packname
                        + "\n"
                        "Emoji is:" + " " + sticker_emoji,
                        parse_mode=ParseMode.MARKDOWN,
...
def makepack_internal(
    ...
    try:
        ...
        if e.message == "Sticker set name is already occupied":
            ...
            msg.reply_text(
                "Sticker pack successfully created. Get it [VALT AOI STICKERS](t.me/addstickers/%s)"
                % packname,
                parse_mode=ParseMode.MARKDOWN,
            )
        return
