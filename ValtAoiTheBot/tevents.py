...
from ValtAoiTheBot import MONGO_DB_URI 
from ValtAoiTheBot import telethn

client = MongoClient()
client = MongoClient(MONGO_DB_URI)
db = client["ValtAoiTheBot"]
gbanned = db.gban
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import ValtAoiTheBot.tevents

        path = Path(f"ValtAoiTheBot/modules/{shortname}.py")
        name = "ValtAoiTheBot.modules.{}".format(shortname)
