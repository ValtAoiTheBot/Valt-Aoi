...
import ValtAoiTheBot.modules.sql.welcome_sql as sql
from ValtAoiTheBot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from ValtAoiTheBot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from ValtAoiTheBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ValtAoiTheBot.modules.helper_funcs.msg_types import get_welcome_type
from ValtAoiTheBot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from ValtAoiTheBot.modules.log_channel import loggable
from ValtAoiTheBot.modules.sql.global_bans_sql import is_user_gbanned
...
OWNER_WELCOME_IMG = "https://telegra.ph/file/b16adfb3b2f0a06f0e264.jpg"
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:1912630709
                update.effective_message.reply_photo(
                    OWNER_WELCOME_IMG, caption= "<code>valt Entered The Chat</code>"
                     ),
                     parse_mode=ParseMode.HTML,
                     reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Surprise!", url="https://t.me/PigasusUpdates")]])
                continue

            # Welcoming my Alt(for tests Lol)
            if new_mem.id == 1912630709:
                update.effective_message.reply_photo(
                    OWNER_WELCOME_IMG, caption= "<code>valt Entered The Chat</code>"
                     ),
                     parse_mode=ParseMode.HTML,
