...
from ValtAoiTheBot import BOT_USERNAME, OWNER_ID, pbot, arq
from ValtAoiTheBot.pyrogramee.pluginshelper import convert_seconds_to_minutes as time_convert
from ValtAoiTheBot.pyrogramee.pluginshelper import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("GET HELP", url=f"t.me/{BOT_USERNAME}?start=start"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
    answerss = [
        InlineQueryResultArticle(
            title="Inline Commands",
            description="Valt Aoi Help Related To Inline Usage",
            input_message_content=InputTextMessageContent(__HELP__),
            thumb_url="https://telegra.ph/file/5cfcaeaa1cc3b5b1763ec.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton(" Main Bot ", url="https://t.me/VALTAOITHEBOT"),
        InlineKeyboardButton(" Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Valt Aoi](t.me/VALTAOITHEBOT):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**My friend:** [BOT](t.me/FreeDeLaHoyarobot) 
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check bot stats",
            thumb_url="https://telegra.ph/file/12b77805ac6008d48a941.jpg",
