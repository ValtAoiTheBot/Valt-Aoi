...
import ValtAoiTheBot.modules.sql.users_sql as sql


from ValtAoiTheBot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater, pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from ValtAoiTheBot.modules import ALL_MODULES
...
from ValtAoiTheBot.modules.helper_funcs.misc import paginate_modules
...
ValtAoi_IMG = "https://telegra.ph/file/cd95b1bd8d5381cb3fb70.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ValtAoiTheBot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ValtAoi_IMG, caption= "<code>valt aoi ʜᴇʀᴇ ғᴏʀ ʏᴏᴜ❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime
            ),
...
@run_async
def Valtaoi_about_callback(update, context):
    query = update.callback_query
    if query.data == "Valtaoi_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Valtaoi_back")
                 ]
                ]
            ),
        )
    elif query.data == "Valtaoi_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="Valtaoi_back")
                 ]
                ]
            ),
        )
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Valtaoi_about_callback, pattern=r"Valtaoi_")
