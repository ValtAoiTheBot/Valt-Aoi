...
from ValtAoiTheBot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from ValtAoiTheBot.__main__ import STATS, TOKEN, USER_INFO
import ValtAoiTheBot.modules.sql.userinfo_sql as sql
...
from ValtAoiTheBot.modules.sql.afk_sql import is_afk, check_afk_status
from ValtAoiTheBot.modules.sql.users_sql import get_user_num_chats
from ValtAoiTheBot.modules.helper_funcs.chat_status import sudo_plus
from ValtAoiTheBot.modules.helper_funcs.extraction import extract_user
from ValtAoiTheBot import telethn as ValtAoiTelethonClient, TIGERS, DRAGONS, DEMONS
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Erm... yeah, I only trust * Valt Aoi * to set my bio.")
            return
