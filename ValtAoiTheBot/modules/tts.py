...
import urllib.parse
import requests
from ValtAoiTheBot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
...
from ValtAoiTheBot.modules.helper_funcs.chat_status import sudo_plus, user_admin
